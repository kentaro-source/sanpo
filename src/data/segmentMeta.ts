...
export const segmentClassifications: SegmentClassification[] = [
  ...
  },
  {
    ...
    //
    // コルカタ(IN-KOLKATA)を意図的に追加(2026-08-01、ユーザー実生活訪問地/
    // visitedInRealLife:true)。プルニア→コルカタ→ダルバンガで実測 +674km の
    // 往復(プルニア→コルカタ368km、コルカタ→ダルバンガ470km、直行164kmとの差)。
    // これはデータ不整合による意図しないジグザグではなく、アテネ/ボゴタ等の
    // 首都スパーと同じ「実生活の思い出を辿る」という設計方針そのものによる
